...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    {
        return $this->services['auth.provider.oauth'] = new \phpbb\auth\provider\oauth\oauth($this->get('dbal.conn'), $this->get('config'), $this->get('passwords.manager'), $this->get('request'), $this->get('user'), 'sq_oauth_tokens', 'sq_oauth_accounts', $this->get('auth.provider.oauth.service_collection'), 'sq_users', $this, './../', 'php');
    }
    ...
    {
        return $this->services['config'] = new \phpbb\config\db($this->get('dbal.conn'), $this->get('cache.driver'), 'sq_config');
    }
    ...
    {
        return $this->services['config_text'] = new \phpbb\config\db_text($this->get('dbal.conn'), 'sq_config_text');
    }
    ...
    {
        return $this->services['content.visibility'] = new \phpbb\content_visibility($this->get('auth'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('user'), './../', 'php', 'sq_forums', 'sq_posts', 'sq_topics', 'sq_users');
    }
    ...
    {
        $instance = new \phpbb\captcha\plugins\qa('sq_captcha_questions', 'sq_captcha_answers', 'sq_qa_confirm');
    ...
    {
        return $this->services['ext.manager'] = new \phpbb\extension\manager($this, $this->get('dbal.conn'), $this->get('config'), $this->get('filesystem'), $this->get('user'), 'sq_ext', './../', 'php', $this->get('cache.driver'));
    }
    ...
    {
        return $this->services['log'] = new \phpbb\log\log($this->get('dbal.conn'), $this->get('user'), $this->get('auth'), $this->get('dispatcher'), './../', 'adm/', 'php', 'sq_log');
    }
    ...
    {
        return $this->services['migrator'] = new \phpbb\db\migrator($this, $this->get('config'), $this->get('dbal.conn'), $this->get('dbal.tools'), 'sq_migrations', './../', 'php', 'sq_', $this->get('migrator.tool_collection'), $this->get('migrator.helper'));
    }
    ...
    {
        return $this->services['migrator.tool.module'] = new \phpbb\db\migration\tool\module($this->get('dbal.conn'), $this->get('cache'), $this->get('user'), './../', 'php', 'sq_modules');
    }
    ...
    {
        return new \phpbb\notification\type\admin_activate_user($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'sq_notification_types', 'sq_notifications', 'sq_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'sq_notification_types', 'sq_notifications', 'sq_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\approve_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'sq_notification_types', 'sq_notifications', 'sq_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\bookmark($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'sq_notification_types', 'sq_notifications', 'sq_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'sq_notification_types', 'sq_notifications', 'sq_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\disapprove_topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'sq_notification_types', 'sq_notifications', 'sq_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'sq_notification_types', 'sq_notifications', 'sq_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\group_request_approved($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'sq_notification_types', 'sq_notifications', 'sq_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'sq_notification_types', 'sq_notifications', 'sq_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'sq_notification_types', 'sq_notifications', 'sq_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\post_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'sq_notification_types', 'sq_notifications', 'sq_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\quote($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'sq_notification_types', 'sq_notifications', 'sq_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'sq_notification_types', 'sq_notifications', 'sq_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_pm_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'sq_notification_types', 'sq_notifications', 'sq_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'sq_notification_types', 'sq_notifications', 'sq_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\report_post_closed($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'sq_notification_types', 'sq_notifications', 'sq_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'sq_notification_types', 'sq_notifications', 'sq_user_notifications');
    }
    ...
    {
        return new \phpbb\notification\type\topic_in_queue($this->get('user_loader'), $this->get('dbal.conn'), $this->get('cache.driver'), $this->get('user'), $this->get('auth'), $this->get('config'), './../', 'php', 'sq_notification_types', 'sq_notifications', 'sq_user_notifications');
    }
    ...
    {
        return $this->services['notification_manager'] = new \phpbb\notification\manager($this->get('notification.type_collection'), $this->get('notification.method_collection'), $this, $this->get('user_loader'), $this->get('config'), $this->get('dispatcher'), $this->get('dbal.conn'), $this->get('cache'), $this->get('user'), './../', 'php', 'sq_notification_types', 'sq_notifications', 'sq_user_notifications');
    }
    ...
    {
        return $this->services['profilefields.lang_helper'] = new \phpbb\profilefields\lang_helper($this->get('dbal.conn'), 'sq_profile_fields_lang');
    }
    ...
    {
        return $this->services['profilefields.manager'] = new \phpbb\profilefields\manager($this->get('auth'), $this->get('dbal.conn'), $this->get('dispatcher'), $this->get('request'), $this->get('template'), $this->get('profilefields.type_collection'), $this->get('user'), 'sq_profile_fields', 'sq_profile_lang', 'sq_profile_fields_data');
    }
    ...
    {
        return $this->services['user_loader'] = new \phpbb\user_loader($this->get('dbal.conn'), './../', 'php', 'sq_users');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            'core.root_path' => './../',
            'core.php_ext' => 'php',
            'tables.auth_provider_oauth_token_storage' => 'sq_oauth_tokens',
            'tables.auth_provider_oauth_account_assoc' => 'sq_oauth_accounts',
            'tables.captcha_qa_questions' => 'sq_captcha_questions',
            'tables.captcha_qa_answers' => 'sq_captcha_answers',
            'tables.captcha_qa_confirm' => 'sq_qa_confirm',
            'tables.config' => 'sq_config',
            'tables.config_text' => 'sq_config_text',
            'tables.ext' => 'sq_ext',
            'tables.forums' => 'sq_forums',
            'tables.log' => 'sq_log',
            'tables.migrations' => 'sq_migrations',
            'tables.modules' => 'sq_modules',
            'tables.notification_types' => 'sq_notification_types',
            'tables.notifications' => 'sq_notifications',
            'tables.profile_fields' => 'sq_profile_fields',
            'tables.profile_fields_data' => 'sq_profile_fields_data',
            'tables.profile_fields_options_language' => 'sq_profile_fields_lang',
            'tables.profile_fields_language' => 'sq_profile_lang',
            'tables.posts' => 'sq_posts',
            'tables.topics' => 'sq_topics',
            'tables.user_notifications' => 'sq_user_notifications',
            'tables.users' => 'sq_users',
